...
export default function AboutSection() {
  return (
    <Box sx={{ bgcolor: "#f5f5f0", py: 10 }} id="about">
      <Container maxWidth="xl">
        <Grid container spacing={6} alignItems="center">
          ...
          {/* Right - Content */}
          <Grid size={{ xs: 12, md: 6 }}>
            <Box sx={{ width: 48, height: 3, bgcolor: "#f5a623", mb: 2 }} />
            <Typography sx={{ color: "#f5a623", fontWeight: 700, fontSize: "0.8rem", letterSpacing: "0.15em", textTransform: "uppercase", mb: 1 }}>
              About Our Company
            </Typography>
            <Typography variant="h3" sx={{ fontWeight: 900, color: "#1a1a1a", mb: 3, lineHeight: 1.2 }}>
